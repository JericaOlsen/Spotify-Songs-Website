...
def test_FileManager_filenotfound():
    ...
    with pytest.raises(FileNotFoundError) as excinfo:
        file = Module7.FileManager("fake.csv")
        file.read_csv()
...
def test_FileManager_emptydataerror():
    ...
    with pytest.raises(pd.errors.EmptyDataError) as excinfo:
        file = Module7.FileManager("empty.csv")
        file.read_csv()
...
def test_Genre_add_song_incorrectsongtype():
    ...
    """
    with pytest.raises(ValueError) as excinfo:
        acoustic = Module7.Genre("Acoustic")
...
def test_Genre_add_song_songalreadyexists():
    ...
    with pytest.raises(ValueError) as excinfo:
        ...
        dict_top_songs = Module7.creat_dict(df)
        genre = Module7.Genre(dict_top_songs[0]['track_genre'])
        song = Module7.Song(
...
def test_organize_genres_keyerror():
    ...
    with pytest.raises(ValueError) as excinfo:
        ...
        Module7.organize_genres(incorrect_dict)
...
def test_organize_genre_notdict():
    ...
    """
    with pytest.raises(ValueError) as excinfo:
        Module7.organize_genres("Incorrect list")
...
def test_get_mean_median_mode_AllGenres():
    ...
    """
    with pytest.raises(ValueError) as excinfo:
        Module7.get_mean_median_mode([], 'popularity')
...
def test_get_mean_median_mode_wrong_values():
    ...
    all_genres = Module7.AllGenres(genre_list)
    with pytest.raises(ValueError) as excinfo:
        Module7.get_mean_median_mode(all_genres, 123)
...
def test_get_mean_median_mode_unknown_value():
    ...
    all_genres = Module7.AllGenres(genre_list)
    with pytest.raises(ValueError) as excinfo:
        Module7.get_mean_median_mode(all_genres, 'swaginess')
...
def test_create_bar_graph_incorrect_df():
    ...
    """
    with pytest.raises(ValueError) as excinfo:
        Module7.create_bar_graph([],"Incorrect Graph")
...
def test_create_bar_graph_incorrect_name():
    ...
    df_data_lists = Module7.get_mean_median_mode(all_genres,'popularity')

    with pytest.raises(ValueError) as excinfo:
        Module7.create_bar_graph(df_data_lists,123)
...
def test_create_pie_incorrect_df():
    ...
    """
    with pytest.raises(ValueError) as excinfo:
        Module7.create_pie([], "Incorrect Pie Chart")
    assert str(excinfo.value) == "Df is not a dataframe"
...
def test_create_pie_incorrect_name():
    ...
    all_genres = Module7.AllGenres(genre_list)
    df = Module7.filter_explicit(all_genres)
    with pytest.raises(ValueError) as excinfo:
        Module7.create_pie(df,123)
    assert str(excinfo.value) == "Name is not a string"
